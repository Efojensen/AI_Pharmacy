  ...
  return (
    <>
      <main className="flex flex-col items-center">
        <StatTileRow/>
        <div className='flex'>
          <div className='flex flex-col w-[62.4375rem] gap-y-[3.8125rem]'>
            ...
            <Card className='pt-[3.875rem]'>
              <div className='flex flex-col px-[1.5625rem] items-start gap-y-[.8125rem] mb-[1.5625rem]'>
                ...
                <h4 className='text-[1rem] tracking-[0.03125rem] leading-[1.4375rem] roboto-font text-pharmacistOverviewText'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab, obcaecati temporibus neque in quam quas earum! Saepe, a.</h4>
              </div>
              <CurvedLinePlot/>
            </Card>
            ...
            <Card className='flex flex-col'>
              <div className='flex w-full justify-between pl-[5.25rem] pr-[1.4375rem]'>
                <DrugsUploadedTile
                  change='2.45%'
                  changeSign="+"
                  quantity="2458"
